...
func NewCmdCreateInstanceGroup(f *util.Factory, out io.Writer) *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&options.Subnets, "subnet", options.Subnets, "Subnets in which to create instance group (e.g. eu-west-1a or a comma-separated list of AZs)")
